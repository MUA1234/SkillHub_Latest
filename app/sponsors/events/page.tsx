...
const SponsorEventsPage = () => {
  ...
  const mockEvents = [
    {
      id: 1,
      title: "Annual Education Technology Summit",
      status: "upcoming",
      date: "2024-05-15",
      ...
      expectedROI: "320%",
      description: "Premier educational technology conference bringing together educators, industry leaders, and technology innovators.",
      targetAudience: "Educators, Tech Leaders, Students",
      isVirtual: false,
      speakers: ["Dr. Sarah Johnson", "Prof. Ananda Silva", "Tech Industry Leaders"],
      benefits: ["Brand visibility", "Lead generation", "Networking opportunities"],
    ...
    },
    {
      ...
      location: "Kandy Education Center",
      type: "Workshop",
      category: "Innovation",
      maxAttendees: 150,
      ...
      expectedROI: "250%",
      description: "Hands-on workshop focused on innovative teaching methods and technology integration in rural schools.",
      targetAudience: "Rural Teachers, Education Officers",
      isVirtual: false,
      speakers: ["Education Experts", "Rural Development Team"],
      benefits: ["Community impact", "Teacher training", "Rural outreach"],
      image: "/images/events/rural-workshop.jpg"
    },
    {
      id: 3,
      title: "Virtual Career Guidance Seminar",
      status: "completed",
      date: "2024-03-25",
      ...
      maxAttendees: 1000,
      registeredAttendees: 875,
      budget: "LKR 150,000",
      sponsorshipLevel: "Silver",
      actualROI: "385%",
      description: "Virtual career guidance session for final year students across multiple disciplines.",
      targetAudience: "University Students, Recent Graduates",
      isVirtual: true,
      speakers: ["Industry Professionals", "HR Leaders"],
      benefits: ["Student placement", "Brand awareness", "Talent pipeline"],
      image: "/images/events/career-seminar.jpg"
    },
    {
      id: 4,
      title: "Science Fair Sponsorship Program",
      status: "planned",
      date: "2024-06-10",
      time: "08:00 AM - 06:00 PM",
      location: "Multiple School Venues",
      type: "Competition",
      category: "Science",
      maxAttendees: 800,
      ...
      sponsorshipLevel: "Platinum",
      expectedROI: "280%",
      description: "Regional science fair competition promoting STEM education and innovation among school students.",
      targetAudience: "School Students, Science Teachers",
      isVirtual: false,
      speakers: ["Scientists", "Innovation Leaders"],
      benefits: ["STEM promotion", "Student engagement", "Innovation showcase"],
