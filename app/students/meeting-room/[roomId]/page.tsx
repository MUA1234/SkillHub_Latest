...
const StudentMeetingRoomPage = () => {
  ...
  useEffect(() => {
    ...
    apiClient.joinSession(roomId).catch(() => {});
  ...
  const displayName = `${currentUser?.profile?.first_name || 'Student'} ${currentUser?.profile?.last_name || ''}`.trim();
