...
import {
  BookOpen, Star, Upload, BarChart3,
  RefreshCw, Clock, ToggleLeft, ToggleRight, ArrowRight,
} from 'lucide-react';
...
/** The General-students dashboard. Only mounts when the teaching mode is
 *  'general' — see the dashboard router. */
export default function NormalTeacherDashboard() {
